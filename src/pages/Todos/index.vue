...
import { ActionTypes } from '@/modules/todo/actions';
import namespace from '@/constants/namespaces';
import { GetterTypes } from '@/modules/todo/getters';
...
export default defineComponent({
  ...
  computed: mapGetters(namespace.todo, [
    GetterTypes.allTodos,
    GetterTypes.isLoading,
  ]),
  methods: {
    ...mapActions(namespace.todo, [
      ActionTypes.fetchTodos,
      ActionTypes.addTodo,
